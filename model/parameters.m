...
param_directory = [base_directory, 'params-traffic/'];
output_directory = [base_directory, 'output-cathywu/'];
...
% tests = {'cvx_random_sampling_L1_30_replace'};
% tests = {'cvx_unconstrained_L1', 'cvx_L2', 'cvx_weighted_L1','cvx_oracle','cvx_raw','cvx_random_sampling_L1_30_replace'};
